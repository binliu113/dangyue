<template lang="html">
    <div class="app-myself">
        <div class="login-hide" v-if="!loginCode">
            <div class="">
                <form action="#">
                    <input type="text" class="uname" placeholder="请输入用户名" v-model="uname">
                    <input type="password" class="upwd" placeholder="请输入登录密码" v-model="upwd">
                    <input type="button" value="登录" @click="loadLogin">
                </form>
            </div>
        </div>
